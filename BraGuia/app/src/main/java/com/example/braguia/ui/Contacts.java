...
public class Contacts extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Back.setOnClickListener (new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(Contacts.this, pagina_inicial.class);
    ...
    private void process_Json(String json) throws JSONException {
        ...
        for (int i=0; i < contactsArray.length(); i++) {
            ...
            dataMAp.put("Title",contact.getString("contact_name"));
            dataMAp.put("Desc1","Phone Number: "+contact.getString("contact_phone")+"\n"+"E-Mail: "+contact.getString("contact_mail"));
            dataMAp.put("Desc2",contact.getString("contact_url"));
